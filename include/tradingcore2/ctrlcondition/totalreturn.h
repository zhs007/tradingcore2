#ifndef __TRADINGCORE2_CTRLCONDITION_TOTALRETURN_H__
#define __TRADINGCORE2_CTRLCONDITION_TOTALRETURN_H__
...
class CCTotalReturn final : public CtrlConditionHelper {
 public:
...
#endif  // __TRADINGCORE2_CTRLCONDITION_TOTALRETURN_H__