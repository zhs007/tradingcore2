#ifndef __TRADINGCORE2_CTRLCONDITION_INDICATORDV_H__
#define __TRADINGCORE2_CTRLCONDITION_INDICATORDV_H__
...
class CCIndicatorDV final : public CtrlConditionHelper {
 public:
...
#endif  // __TRADINGCORE2_CTRLCONDITION_INDICATORDV_H__