#ifndef __TRADINGCORE2_CTRLCONDITION_WAITTOSTART_H__
#define __TRADINGCORE2_CTRLCONDITION_WAITTOSTART_H__
...
class CCWaitToStart final : public CtrlConditionHelper {
 public:
  static void regCtrlConditionHelper();

 protected:
  CCWaitToStart() {}
  virtual ~CCWaitToStart() {}
...
#endif  // __TRADINGCORE2_CTRLCONDITION_WAITTOSTART_H__