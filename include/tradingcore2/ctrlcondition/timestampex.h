#ifndef __TRADINGCORE2_CTRLCONDITION_TIMESTAMPEX_H__
#define __TRADINGCORE2_CTRLCONDITION_TIMESTAMPEX_H__
...
class CCTimestampEx final : public CtrlConditionHelper {
 public:
...
#endif  // __TRADINGCORE2_CTRLCONDITION_TIMESTAMPEX_H__