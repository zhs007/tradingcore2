#ifndef __TRADINGCORE2_CTRLCONDITION_INDICATORSVAREA_H__
#define __TRADINGCORE2_CTRLCONDITION_INDICATORSVAREA_H__
...
class CCIndicatorSVArea final : public CtrlConditionHelper {
 public:
  static void regCtrlConditionHelper();

 protected:
  CCIndicatorSVArea() {}
  virtual ~CCIndicatorSVArea() {}
...
#endif  // __TRADINGCORE2_CTRLCONDITION_INDICATORSVAREA_H__