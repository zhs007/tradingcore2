#ifndef __TRADINGCORE2_CTRLCONDITION_TOTALRETURNEX_H__
#define __TRADINGCORE2_CTRLCONDITION_TOTALRETURNEX_H__
...
class CCTotalReturnEx final : public CtrlConditionHelper {
 public:
...
#endif  // __TRADINGCORE2_CTRLCONDITION_TOTALRETURNEX_H__