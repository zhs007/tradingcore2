#ifndef __TRADINGCORE2_CTRLCONDITION_INDICATORDP_H__
#define __TRADINGCORE2_CTRLCONDITION_INDICATORDP_H__
...
class CCIndicatorDP final : public CtrlConditionHelper {
 public:
...
#endif  // __TRADINGCORE2_CTRLCONDITION_INDICATORDP_H__