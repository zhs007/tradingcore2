#ifndef __TRADINGCORE2_CTRLCONDITION_MONTH_H__
#define __TRADINGCORE2_CTRLCONDITION_MONTH_H__
...
class CCMonth final : public CtrlConditionHelper {
 public:
...
#endif  // __TRADINGCORE2_CTRLCONDITION_MONTH_H__