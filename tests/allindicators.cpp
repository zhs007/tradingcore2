...
TEST(AllIndicators, newWithAvgTimes) {
  ...
  EXPECT_TRUE(mgr->newIndicator("ta-sma.5") != NULL);
  EXPECT_TRUE(mgr->newIndicator("ta-ema.5") != NULL);
  EXPECT_TRUE(mgr->newIndicator("ta-wma.5") != NULL);
  EXPECT_TRUE(mgr->newIndicator("ta-dema.5") != NULL);
  EXPECT_TRUE(mgr->newIndicator("ta-tema.5") != NULL);
  EXPECT_TRUE(mgr->newIndicator("ta-trima.5") != NULL);
  EXPECT_TRUE(mgr->newIndicator("ta-kama.5") != NULL);
  EXPECT_TRUE(mgr->newIndicator("ta-mama.5") != NULL);
  EXPECT_TRUE(mgr->newIndicator("ta-t3.5") != NULL);
}