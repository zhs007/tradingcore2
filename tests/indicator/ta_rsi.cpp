...
class TARSITest : public testing::Test {
 protected:
...
TEST_F(TARSITest, rsi_2) {
  tr2::IndicatorTA_RSI* pRSI =
      (tr2::IndicatorTA_RSI*)tr2::IndicatorTA_RSI::newIndicator("ta-rsi.2",
                                                                "110022");
  ...
  //   LOG(INFO) << "TARSITest:rsi_2 [2] " << pRSI->getSingleValue(2)->value;
  ...
  //   LOG(INFO) << "TARSITest:rsi_2 [3] " << pRSI->getSingleValue(3)->value;
  ...
  //               100 - 100 / (1 + pRSI->getSMMAU(4) / pRSI->getSMMAD(4)),
  //               0.00005);
  EXPECT_NEAR(pRSI->getSingleValue(4)->value, 42.8571, 0.00005);
  ...
  //               100 - 100 / (1 + pRSI->getSMMAU(2278) /
  //               pRSI->getSMMAD(2278)), 0.00005);
  EXPECT_NEAR(pRSI->getSingleValue(2278)->value, 94.2757, 0.00005);
  ...
  //               100 - 100 / (1 + pRSI->getSMMAU(2279) /
  //               pRSI->getSMMAD(2279)), 0.00005);
  EXPECT_NEAR(pRSI->getSingleValue(2279)->value, 94.7876, 0.00005);
}

TEST_F(TARSITest, rsi_3) {
  tr2::IndicatorTA_RSI* pRSI =
      (tr2::IndicatorTA_RSI*)tr2::IndicatorTA_RSI::newIndicator("ta-rsi.3",
                                                                "110022");
  ...
  //   EXPECT_NEAR(pRSI->getU(1), 0.0009, 0.00005);
  //   EXPECT_NEAR(pRSI->getD(1), 0, 0.00005);
  //   EXPECT_NEAR(pRSI->getSMMAU(1), (2 * pRSI->getSMMAU(0) + pRSI->getU(1)) /
  //   3,
  //               0.00005);
  //   EXPECT_NEAR(pRSI->getSMMAD(1), 0, 0.00005);
  EXPECT_NEAR(pRSI->getSingleValue(1)->value, 100, 0.00005);
  ...
  //   EXPECT_NEAR(pRSI->getU(2), 1.006 - 1.0009, 0.00005);
  //   EXPECT_NEAR(pRSI->getD(2), 0, 0.00005);
  //   EXPECT_NEAR(pRSI->getSMMAU(2), (2 * pRSI->getSMMAU(1) + pRSI->getU(2)) /
  //   3,
  //               0.00005);
  //   EXPECT_NEAR(pRSI->getSMMAD(2), 0, 0.00005);
  EXPECT_NEAR(pRSI->getSingleValue(2)->value, 100, 0.00005);
  ...
  //   EXPECT_NEAR(pRSI->getU(3), 1.006 - 1.006, 0.00005);
  //   EXPECT_NEAR(pRSI->getD(3), 0, 0.00005);
  //   EXPECT_NEAR(pRSI->getSMMAU(3), (2 * pRSI->getSMMAU(2) + pRSI->getU(3)) /
  //   3,
  //               0.00005);
  //   EXPECT_NEAR(pRSI->getSMMAD(3), 0, 0.00005);
    EXPECT_NEAR(pRSI->getSingleValue(3)->value, 100, 0.00005);
  ...
  //   EXPECT_NEAR(pRSI->getU(4), 0, 0.00005);
  //   EXPECT_NEAR(pRSI->getD(4), 1.006 - 1.004, 0.00005);
  //   EXPECT_NEAR(pRSI->getSMMAU(4), (2 * pRSI->getSMMAU(3) + pRSI->getU(4)) /
  //   3,
  //               0.00005);
  //   EXPECT_NEAR(pRSI->getSMMAD(4), (2 * pRSI->getSMMAD(3) + pRSI->getD(4)) /
  //   3,
  //               0.00005);
  //   EXPECT_NEAR(pRSI->getSingleValue(4)->value,
  //               100 - 100 / (1 + pRSI->getSMMAU(4) / pRSI->getSMMAD(4)),
  //               0.00005);
  EXPECT_NEAR(pRSI->getSingleValue(4)->value, 66.66666, 0.00005);
  ...
  //               100 - 100 / (1 + pRSI->getSMMAU(2278) /
  //               pRSI->getSMMAD(2278)), 0.00005);
  EXPECT_NEAR(pRSI->getSingleValue(2278)->value, 76.4016517, 0.00005);
  ...
  //               100 - 100 / (1 + pRSI->getSMMAU(2279) /
  //               pRSI->getSMMAD(2279)), 0.00005);
  EXPECT_NEAR(pRSI->getSingleValue(2279)->value, 77.5018556, 0.00005);
}